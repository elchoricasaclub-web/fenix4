...
import { ArrowLeft, Beaker, CheckCircle, Save, AlertTriangle, Download, Plus } from 'lucide-react';
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" value={formData.batchId} onChange={(e) => handleInputChange('batchId', e.target.value)} className={`w-full px-3 py-2 bg-slate-800 text-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.batchId ? 'border-rose-500' : 'border-slate-600'}`} />
                ...
                <div>
                  ...
                  <input type="text" value={formData.flowerBatchId} onChange={(e) => handleInputChange('flowerBatchId', e.target.value)} className={`w-full px-3 py-2 bg-slate-800 text-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.flowerBatchId ? 'border-rose-500' : 'border-slate-600'}`} />
                ...
                <div>
                  ...
                  <input type="text" value={formData.responsible} onChange={(e) => handleInputChange('responsible', e.target.value)} className={`w-full px-3 py-2 bg-slate-800 text-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.responsible ? 'border-rose-500' : 'border-slate-600'}`} />
                ...
                <div>
                  ...
                  <input type="number" step="0.01" value={formData.initialWeight} onChange={(e) => handleInputChange('initialWeight', e.target.value)} className={`w-full px-3 py-2 bg-slate-800 text-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.initialWeight ? 'border-rose-500' : 'border-slate-600'}`} />
              ...
              <div className="border-t border-slate-700/50 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input type="number" step="0.1" value={formData.waterTemp} onChange={(e) => handleInputChange('waterTemp', e.target.value)} className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Tiempo Agitación (min)</label>
                    <input type="number" value={formData.agitationTime} onChange={(e) => handleInputChange('agitationTime', e.target.value)} className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Número de Lavadas</label>
                    <input type="number" value={formData.washCount} onChange={(e) => handleInputChange('washCount', e.target.value)} className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                </div>
              </div>
                  ...
                  {['220', '190', '160', '120', '90', '73', '45', '25'].map(micron => (
                    <div key={micron}>
                      ...
                      <input 
                        ...
                        className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" 
                        placeholder="0.00"
                      />
                    </div>
                  ))}
              ...
              <div className="border-t border-slate-700/50 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <select value={formData.dryingMethod} onChange={(e) => handleInputChange('dryingMethod', e.target.value)} className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                  ...
                  <div>
                    ...
                    <input type="number" step="0.1" value={formData.finalMoisture} onChange={(e) => handleInputChange('finalMoisture', e.target.value)} className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Actividad de Agua (aw)</label>
                    <input type="number" step="0.01" value={formData.waterActivity} onChange={(e) => handleInputChange('waterActivity', e.target.value)} className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Estado de Calidad *</label>
                    <select value={formData.qualityStatus} onChange={(e) => handleInputChange('qualityStatus', e.target.value)} className="w-full px-3 py-2 bg-slate-800 text-white border border-slate-600 rounded-lg font-medium focus:outline-none focus:ring-2 focus:ring-blue-500">
                  ...
                  <div>
                    ...
                    <input type="text" value={formData.notes} onChange={(e) => handleInputChange('notes', e.target.value)} className={`w-full px-3 py-2 bg-slate-800 text-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.notes ? 'border-rose-500' : 'border-slate-600'}`} placeholder="Requerido si es rechazado" />
